...
val pentaclesCards = listOf(
    ...
    TarotCardDetail(
        ...
        history = """
        This card represents the value of focused work and the rewards of honing one’s craft, often depicted as an artisan at work.
    """.trimIndent(),
        meaningUpright = """
    ...
    """.trimIndent(),
        ...
        history = """
        Rooted in imagery of wealth and comfort, this card symbolizes self-achievement and enjoying the fruits of one’s labor.
    """.trimIndent(),
        meaningUpright = """
